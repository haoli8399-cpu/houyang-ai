...
| 优先级 | # | 任务 | 说明 |
|--------|---|------|------|
| 🔴 | 1 | 通话记录存储 | SQLite 记录通话+ASR 文字+录音文件 |
| 🔴 | 2 | 录音持久化 | 从 /tmp 移到 records/{call_id}/ |
| 🟡 | 3 | DeepSeek API Key 安全 | 硬编码的 fallback Key 移到环境变量 |
| 🟡 | 4 | 转人工坐席对接 | 分机 9999 → 真实手机/坐席 |
| 🟢 | 5 | System Prompt 热更新 | 不重启可修改 AI 对话风格 |
| 🟢 | 6 | 日志轮转 | 防止日志无限增长 |
| 🟢 | 7 | FastAPI 管理后台 | 通话记录/健康看板/录音播放 |
